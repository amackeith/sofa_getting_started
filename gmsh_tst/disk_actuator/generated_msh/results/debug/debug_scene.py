...
originalScene = r'/home/arthur/Documents/sofa/my_projects/test_scene/gmsh_tst/disk_actuator/generated_msh/mor_disk_actuator.py'
originalScene = os.path.normpath(originalScene)
originalScene = imp.load_source(originalScene.split(slash)[-1], originalScene)

paramWrapper = ('/modelNode', {'paramForcefield': {'periodSaveGIE': 6, 'prepareECSW': True, 'modesPath': '/home/arthur/Documents/sofa/my_projects/test_scene/gmsh_tst/disk_actuator/generated_msh/results/data/modes.txt', 'nbTrainingSet': 8}, 'paramMORMapping': {'input': '@../MechanicalObject', 'modesPath': '/home/arthur/Documents/sofa/my_projects/test_scene/gmsh_tst/disk_actuator/generated_msh/results/data/modes.txt'}, 'paramMappedMatrixMapping': {'object1': '@./MechanicalObject', 'object2': '@./MechanicalObject', 'template': 'Vec1d,Vec1d', 'timeInvariantMapping2': True, 'performECSW': False, 'timeInvariantMapping1': True, 'nodeToParse': '@./modelNode'}})
